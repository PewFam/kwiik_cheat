...
function openPedia() {
    document.getElementById("pedia").style.width = "50%";
    document.getElementById("pedia").style.height = "50%";
...
setInterval(function(){ 
    ...
    if (kiwis > pediaPrice - 1) {
        document.getElementById('buyPediaButton').style.border = "rgb(199,64,6) solid 5px";
        document.getElementById('buyPediaButton').style.color = "rgb(199,64,6)";
